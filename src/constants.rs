...
pub const XL_WIDE_ROAD_INNER_WIDTH: f32 = 0.9;
pub const XL_WIDE_ROAD_OUTER_WIDTH: f32 = 1.18;
pub const XXL_WIDE_ROAD_INNER_WIDTH: f32 = 1.35;
pub const XXL_WIDE_ROAD_OUTER_WIDTH: f32 = 1.63;
