...
:::caution
If your operating système is Windows, you might prefer install Cassini using the [Docker](#installing-with-docker) method, as the Conda method is not stable yet for Windows.
:::
...
First you will need to install <GlossaryLink slug="docker" />. Got to the project's front page, hover the "Download Docker Desktop" dropdown and select your operating system. Then follow the instructions and/or the installation wizard.
...
<Tabs syncKey="os">
  <TabItem label="Windows" icon="seti:windows">
>    ```sh
>    docker run -it -name cassini -v "%cd%":/app nicorio42/cassini
>    ```
  </TabItem>
  
  <TabItem label="macOS" icon="apple">
>    ```sh
>    docker run -it -name cassini -v "$(pwd)":/app nicorio42/cassini
>    ```
  </TabItem>
...
<Tabs syncKey="os">
  <TabItem label="Windows" icon="seti:windows">
>    ```sh
>    docker run -it -name cassini -v "%cd%":/app nicorio42/cassini ./tile.laz
>    ```
  </TabItem>
  
  <TabItem label="macOS" icon="apple">
>    ```sh
>    docker run -it -name cassini -v "$(pwd)":/app nicorio42/cassini ./tile.laz
>    ```
  </TabItem>
