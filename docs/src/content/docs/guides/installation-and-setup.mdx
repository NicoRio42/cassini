...
> ```
>
> This opens the profile script in Notepad. If the file doesn't exist, this command will create it. Add the following PowerShell function in your profile script:
>
> ```sh
> function cassini {
